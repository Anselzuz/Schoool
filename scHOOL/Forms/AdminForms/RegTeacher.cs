...
namespace scHOOL.Forms.AdminForms
{
    ...
    {
        public RegTeacher(AdminMainForm mainForm)
        {
            InitializeComponent();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Введен некорректный номер телефона.", "РЕГИСТРАЦИЯ УЧИТЕЛЯ");
                return;
            }

            MessageBox.Show(admin.RegistrationTeacher(textBox4.Text, textBox3.Text, phoneNum, textBox2.Text, textBox5.Text), "РЕГИСТРАЦИЯ УЧИТЕЛЯ");
        }
